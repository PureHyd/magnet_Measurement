...
class ips120():
    ...
    def readField(self):
        ...
        return float(value_str.strip(u'\nR'))
    ...
    def setFieldSetpoint(self, field):
        ...
        Args:
            field(): the magnetic field set point, in Tesla
        """
        MAX_FIELD = 16
    ...
    def waitForField(self, timeout=9000, error_margin=0.01):
        ...
        stop_time = start_time + timedelta(seconds = timeout)
